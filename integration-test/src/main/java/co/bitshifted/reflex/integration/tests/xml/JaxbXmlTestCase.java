...
public class JaxbXmlTestCase extends BaseXmlTestCase {
  private static final String XML_GET_WITH_RESPONSE_BODY = "jaxb_xml_get_xml_with_response_body";
  private static final String XML_POST_WITH_RESPONSE_BODY = "jaxb_xml_post_xml_with_response_body";
